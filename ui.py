...
class View(QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.date=QDate.currentDate() # 현재 날짜를 date에 저장
        self.initUI()

    def initUI(self):
        self.lbl1=QLabel(self.date.toString(Qt.DefaultLocaleLongDate), self) # 현재 날짜 출력 추가
        ...
        vbox.addLayout(hbox)
        vbox.addWidget(self.lbl1) # 현재 날짜 출력 추가
